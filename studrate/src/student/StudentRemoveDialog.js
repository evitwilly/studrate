...
export default class StudentRemoveDialog extends React.Component {
		...
		return (
			<div className="core_container_dialog">
				<div className="core_dialog">
					<h4 className="core_dialog_title">Удаление студента
					...
					<p className="core_dialog_content_text">Вы действительно хотите удалить студента?</p>
					<div className="core_dialog_buttons">
						<div className="core_dialog_apply_button core_dialog_yes_button" onClick={() => {
							...
							axios.post(constants.restData.postStudentRemove, { id: this.props.studentId }).then(response => {
